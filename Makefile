...
#    Updated: 2023/03/03 12:38:59 by yothmani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_isdigit.c ft_isprint.c ft_memcpy.c ft_toupper.c ft_tolower.c\
...
ft_putnbr_fd.c ft_strmapi.c  ft_strchr.c ft_isascii.c ft_striteri.c\
